    ...
    <div className="bg-main font-main text-gray-100 overflow-hidden bg-gradient-to-t from-[#8d7341] to-[#c9ba7b] min-h-screen">
      ...
      <div className="relative bg-[url('/main.jpg')] bg-cover bg-center flex flex-col justify-center items-center py-56 lg:py-60 text-center">
        ...
        <div className="relative z-10">
          ...
          {/* Foglalás button */}
          <button className="mt-14 md:mt-16 hover:bg-opacity-80 transition-all duration-300 lg:mt-14 sm:px-12 p-4 px-12 py-3 md:px-12 bg-[#8d7341] bg-opacity-60 backdrop-blur-[2px] custom:hidden text-lg border border-[#b49f5b] hover:bg-[#8d7341] rounded-2xl ease-in-out" 
